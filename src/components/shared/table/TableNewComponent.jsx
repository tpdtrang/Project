...
class TableNewComponent extends Component {
  constructor(props) {
    super(props);
    this.state = {
      pagOfItem: [],
  ...
  render() {
    if (this.state.redirect) {
      return (
        <Redirect to={'/formnew/' + this.state.id}></Redirect>
      )
    }
    return (
      <section className="tablenews-container">
        <div className="row">
          <div className="col-lg-6">
            <div className="p-title">
              <h3 className="heading-3"> Table News</h3>
            </div>
          </div>
          <div className="col-lg-6">
